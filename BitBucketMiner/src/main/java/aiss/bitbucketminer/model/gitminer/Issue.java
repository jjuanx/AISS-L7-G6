...
@Entity
@Table(name = "Issue")
@JsonPropertyOrder({ "id", "ref_id", "title", "description", "state", "created_at", "updated_at", "closed_at", "labels", "author", "assignee", "upvotes", "downvotes", "web_url", "comments" })
public class Issue {
    ...
    private List<Comment> GMComments;
    ...
    public void setComments(List<Comment> GMComments) {
