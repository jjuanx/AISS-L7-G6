...
class UserControllerTest {
    ...
    void getUserById() {
        User newUser = new User(UUID.randomUUID().toString(), "testUser", "Test");
    ...
    void createUser() {
        User newUser = new User(UUID.randomUUID().toString(), "newUser", "New");
    ...
    void deleteUser() {
        User newUser = new User(UUID.randomUUID().toString(), "deleteUser", "Delete");
        ResponseEntity<User> postResponse = restTemplate.postForEntity(getBaseUrl(), newUser, User.class);
    ...
    @Test
    @DisplayName("DELETE /users/{id} returns NO_CONTENT for invalid ID")
